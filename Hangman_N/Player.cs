...
namespace Hangman_N
{
    ...
    public class Player : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.Select_P);

            ConClass myConnectionClass = new ConClass();
            myList = myConnectionClass.ViewAll();

            PlayerNameSpinner = FindViewById<Spinner>(Resource.Id.selectPlayerSpinner);
            Hangman_N.Resources.List_Adp da = new Resources.List_Adp(this, myList);
        ...
        private void btnAddPlayer_Click(object sender, EventArgs e)
        {
            ...
            if (txtEnterPlayerName.Text.Length > 0)
            {
                ...
                PlayerNameSpinner.Adapter = da;
                Toast.MakeText(this, " Record Saved and Please Click On Start Game ", ToastLength.Short).Show();
